...
class LocalImageSelectPage extends StatefulWidget {
  ...
  LocalImageSelectPage({Key? key, required this.isjustshow}) : super(key: key);
...
class _LocalImageSelectPageState extends State<LocalImageSelectPage> {
        ...
        child: _albums.isNotEmpty
            ? DropdownButton<Album>(
                ...
                style: const TextStyle(
                    fontFamily: 'BaseFont', color: Colors.black, fontSize: 10),
                elevation: 10,
                items: _albums
  ...
  AppBar _justshow() {
    return !widget.isjustshow
        ? AppBar(
            iconTheme: const IconThemeData(color: Colors.black),
            title: const Text("사진 선택", style: fontTitle),
            centerTitle: true,
            elevation: 0.5,
